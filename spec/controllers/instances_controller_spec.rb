...
describe InstancesController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all instances as @instances" do
      Instance.should_receive(:find).with(:all).and_return([mock_instance])
      get :index
    ...
    describe "with mime type of xml" do
      ...
      it "should render all instances as xml" do
        ...
        Instance.should_receive(:find).with(:all).and_return(instances = mock("Array of Instances"))
  ...
  describe "responding to GET new" do
    ...
    it "should expose a new instance as @instance" do
      Instance.should_receive(:new).and_return(mock_instance)
      get :new
      assigns[:instance].should equal(mock_instance)
    end
  ...
  describe "responding to POST create" do
    ...
    describe "with valid params" do
      ...
      it "should expose a newly created instance as @instance" do
        Instance.should_receive(:new).with({'these' => 'params'}).and_return(mock_instance(:save => true))
